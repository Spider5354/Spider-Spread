...
# Correção da linha 28: CSS em linha única para evitar o erro de aspas abertas (unterminated string)
...
def obter_conexao_direta():
    # URL de conexão no formato bruto para anular de vez qualquer cache ou variável oculta
